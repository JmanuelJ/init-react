          ...
          <div className="flex items-center space-x-4">
            <div className="hidden md:flex items-center space-x-2">
              <div className="relative">
                ...
                <Input
                  ...
                  className="bg-white pl-9 w-64 h-9"
...

            {
              authStatus === 'not-authenticated' ? (
                ...
                <Button variant="default" size="sm" className="ml-2" onClick={logout}>Cerrar sesion</Button>
              )
            }
            {
              isAdmin() && (
                <Link to="/admin">
                  <Button variant="destructive" size="sm" className="ml-2">Admin</Button>
                </Link>
              )
            }
          </div>
