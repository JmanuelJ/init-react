...
export const LoginPage = () => {
  ...
  const handleLogin = async (event: FormEvent<HTMLFormElement>) => {
    ...
    toast.error('Correro o/y contraseña no validos');
    setIsPosting(false);
  };
  ...
  return (
    <div className={"flex flex-col gap-6"}>
          ...
          <form className="p-6 md:p-8" onSubmit={handleLogin}>
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                ...
                <Input id="password" name='password' type="password" required autoComplete='off' placeholder='Contraseña' />
              </div>
      ...
      <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary">
        Haciendo click, estás de acuerdo con <a href="#">Términos y condiciones</a> y <a href="#">Politicas de privacidad</a>.
      </div>
    </div>
  );
};